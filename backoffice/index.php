...
?>
    <!DOCTYPE html>
    <html ng-app="indexApp" ng-controller="indexCtrl" lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <form id="frm" name="frm" ng-submit="processForm()" novalidate>
        ...
        <div id="login_data" class="container">
            <table border="1" class="table table-bordered table-responsive">
                ...
                <tr>
                    <th>Login:</th>
                    <td><input type="text" id="txt_login" name="txt_login" class="form-control" placeholder="Enter your login"
    ...
    <script src="../lib/backoffice_index_controller.js"></script>
